...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      RESOURCE_API: "http://calendarapp.test/api",
      event: {},
      schedule: []
    };
  },
  methods: {
    getEvent: function getEvent(eventId) {
      ...
      axios.get(this.RESOURCE_API + "/calendar/events/".concat(eventId, "?include=schedule")).then(function (response) {
        console.log(response);
        _this.event = response.data.data;
        _this.schedule = _this.event.schedule.data; //this.events = response.data.data;
        //let 
      });
    }
  }
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/EventForm.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/EventForm.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    saveEvent: function saveEvent() {
      ...
      axios.post(this.RESOURCE_API + '/calendar', this.fields).then(function (response) {
        console.log(response);
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/EventList.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/EventList.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "calendar" } }, [
    _c(
      ...
      [_c("event-form", { on: { newEvent: _vm.getEvent } })],
      1
    ),
    _vm._v(" "),
    _c(
      ...
      [_c("event-list", { attrs: { event: _vm.event } })],
      1
    )
  ])
}
  ...
  return _c(
    ...
    [
      ...
      _c("input", {
        ...
        attrs: { type: "date", name: "from", id: "from" },
        ...
        directives: [
          {
            ...
            rawName: "v-model",
            value: _vm.fields.to,
            expression: "fields.to"
          }
        ],
        attrs: { type: "date", name: "to", id: "to" },
        domProps: { value: _vm.fields.to },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.fields, "to", $event.target.value)
          }
        }
      }),
      _c("br"),
      ...
      _c(
        ...
        _vm._l(_vm.weekdays, function(day) {
          return _c("li", { staticStyle: { display: "inline-block" } }, [
            _c("input", {
              directives: [
                {
                  name: "model",
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(this.$parent.schedule, function(item) {
      return _c("tr", [
        _c("td", [
          _vm._v(_vm._s(item.month_day) + " " + _vm._s(item.week_day))
        ]),
        _vm._v(" "),
        _c("td", [_vm._v(_vm._s(item.flag ? _vm.event.name : null))])
      ])
    }),
    0
  )
...
Vue.component('event-list', __webpack_require__(/*! ./components/EventList.vue */ "./resources/js/components/EventList.vue")["default"]);
var app = new Vue({
  el: '#app'
});
...
/***/ "./resources/js/components/EventForm.vue":
/*!***********************************************!*\
  !*** ./resources/js/components/EventForm.vue ***!
  \***********************************************/
/*! exports provided: default */
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/EventForm.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/EventForm.vue?vue&type=script&lang=js&":
/*!************************************************************************!*\
  !*** ./resources/js/components/EventForm.vue?vue&type=script&lang=js& ***!
  \************************************************************************/
/*! exports provided: default */
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/EventList.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/EventList.vue?vue&type=script&lang=js&":
/*!************************************************************************!*\
  !*** ./resources/js/components/EventList.vue?vue&type=script&lang=js& ***!
  \************************************************************************/
/*! exports provided: default */
...
__webpack_require__(/*! /home/zichri/Projects/www/calendar-app/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/zichri/Projects/www/calendar-app/resources/sass/app.scss */"./resources/sass/app.scss");
